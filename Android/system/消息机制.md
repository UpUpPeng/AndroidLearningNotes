...
- [2. MeaasgeQueue](#2-meaasgequeue)
  - [2.1. MeaasgeQueue的插入](#21-meaasgequeue的插入)
  - [2.2. MeaasgeQueue的读取](#22-meaasgequeue的读取)
  - [2.3. MeaasgeQueue的退出](#23-meaasgequeue的退出)
- [3. Lopper](#3-lopper)
...
![img](https://raw.githubusercontent.com/UpUpPeng/AndroidLearningNotes/main/img/20201128-223226-48a771b2cf1050089661ada4b52d2f26.png)

- Handler 创建后，内部的 Lopper 和 MeaasgeQueue 和 Handler 协同工作。
- Handler 的 post 或 send 方法，会调用 MeaasgeQueue  的 enqueueMessage 方法，把 Runnable 或 Message 放入到消息队列中。
...
![img](https://raw.githubusercontent.com/UpUpPeng/AndroidLearningNotes/main/img/20201128-223814-86a5e0edd1259347efb3953305e1d1d8.png)
...
- [2. 线程](#2-线程)
  ...
  - [2.2. 创建线程](#22-创建线程)
    - [2.2.1. 直接创建 Thread](#221-直接创建-thread)
    - [2.2.2. 结合 Runnable](#222-结合-runnable)
    - [2.2.3. 结合 FutureTask](#223-结合-futuretask)
  - [2.3. 常见方法](#23-常见方法)
    - [2.3.1. start() 与 run()](#231-start-与-run)
    - [2.3.2. sleep() 与 yield()](#232-sleep-与-yield)
    - [2.3.3. join()](#233-join)
    - [2.3.4. interrupt()](#234-interrupt)
  - [2.4. 终止线程-两阶段终止法](#24-终止线程-两阶段终止法)
  - [2.5. 主线程与守护线程](#25-主线程与守护线程)
  - [2.6. 线程的状态（五种）](#26-线程的状态五种)
  - [2.7. 线程的状态（六种）](#27-线程的状态六种)
